const data ={
  "bio": [
    "Hi, I'm Anders Henriksen - I hold a Master’s degree in Artificial Intelligence and Data from DTU (Technical University of Denmark), with extensive Python experience gained at Novo Nordisk and Danske Bank.",
    "I specialize in software engineering, design thinking, and top-down development - turning complex stakeholder requirements into clear, actionable tasks that can be efficiently distributed across teams.",
    "I'm passionate about clean code, mentoring, and promoting engineering excellence through collaboration, automation, and continuous improvement.",
  ],
  "skills": [
    "Python",
    "SQL",
    ...
    "CI/CD",
    "Terraform",
    "Version Controls Best Practices",
    "Agile Methodologies",
    "NumPy",
    "Pandas",
    "Jupyter Notebook",
  ...
  "education": [
    {
      "title": "MSc Human-centered Artificial Intelligence",
      "duration": "2023 - 2024",
  ...
  "contactLinks": [
    {
      "label": "Email",
      "link": "mailto:anders-10@live.dk",
      "icon": "fa fa-envelope"
    },
    {
      "label": "LinkedIn",
      "link": "https://www.linkedin.com/in/andershenriksen/",
      "icon": "fa-brands fa-linkedin"
    },
    {
      "label": "GitHub",
      "link": "https://github.com/AndersHenriksen-dev",
      "icon": "fa-brands fa-github"
    },
    {
      "label": "Buy me a coffee",
      "link": "https://buymeacoffee.com/andershenriksen",
      "icon": "fa fa-coffee"
    }
  ],
  "footer": [
